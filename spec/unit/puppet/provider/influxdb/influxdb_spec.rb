...
RSpec.describe Puppet::Provider::Influxdb::Influxdb do
  ...
  describe 'create(context, name, should)' do
    it 'creates the resource' do
      expect(context).to receive(:notice).with(/\ACreating 'a'/)
  ...
  describe 'update(context, name, should)' do
    it 'updates the resource' do
      expect(context).to receive(:notice).with(/\AUpdating 'foo'/)
  ...
  describe 'delete(context, name)' do
    it 'deletes the resource' do
      expect(context).to receive(:notice).with(/\ADeleting 'foo'/)
